...
(      
    CategoryID INTEGER PRIMARY KEY generated by default as identity(increment 1 start 1),
    CategoryName TEXT,
    Description TEXT
);
...
(      
    CustomerID INTEGER PRIMARY KEY generated by default as identity(increment 1 start 1),
    CustomerName TEXT,
    ContactName TEXT,
    Address TEXT,
    City TEXT,
...
(
    EmployeeID INTEGER PRIMARY KEY generated by default as identity(increment 1 start 1),
    LastName TEXT,
    FirstName TEXT,
    BirthDate DATE,
    Photo TEXT,
...
CREATE TABLE Shippers(
    ShipperID INTEGER PRIMARY KEY generated by default as identity(increment 1 start 1),
    ShipperName TEXT,
    Phone TEXT
);

CREATE TABLE Suppliers(
    SupplierID INTEGER PRIMARY KEY generated by default as identity(increment 1 start 1),
    SupplierName TEXT,
    ContactName TEXT,
    Address TEXT,
    City TEXT,
...
CREATE TABLE Products(
    ProductID INTEGER PRIMARY KEY generated by default as identity(increment 1 start 1),
    ProductName TEXT,
    SupplierID INTEGER,
    CategoryID INTEGER,
    Unit TEXT,
...
CREATE TABLE Orders(
    OrderID INTEGER PRIMARY KEY generated by default as identity(increment 1 start 1),
    CustomerID INTEGER,
    EmployeeID INTEGER,
    OrderDate DATE,
    ShipperID INTEGER,
...
CREATE TABLE OrderDetails(
    OrderDetailID INTEGER PRIMARY KEY generated by default as identity(increment 1 start 1),
    OrderID INTEGER,
    ProductID INTEGER,
    Quantity INTEGER,
